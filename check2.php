...
$processesAndCommands = array(
    "cloudflared" => array("cd /home/u0123456789/domains/yourdomain.tld/public_html/Django_on_Shared_hosting_plan_Hostinger && nohup ./cloudflared tunnel run your_tunnel_name & pkill -f php")
);
